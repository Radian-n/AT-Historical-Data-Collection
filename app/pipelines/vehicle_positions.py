...
class VehiclePositionsPipeline(BaseRealtimePipeline):
    ...
    def normalise(self, feed, poll_time: datetime) -> list[dict]:
        ...
        for entity in feed.entity:
            ...
            row = {
                ...
                VehiclePositionColumns.LICENSE_PLATE: v.vehicle.license_plate or None,
                # Trip/route info
                ...
                VehiclePositionColumns.SCHEDULE_RELATIONSHIP: v.trip.schedule_relationship,
